...
const PaymentCard = ({price , title , subtitle }) => {
    return (
        <div className="md:w-[300px] mx-auto space-y-8 shadow-[0px_0px_30px_2px_rgba(100,100,111,0.1)] my-20 relative p-8">
            ...
            <div className="space-y-4 mt-4">
                ...
                <h3 className="text-2xl font-bold text-slate-800">{ subtitle}</h3>
                <ul className="space-y-3">
                    <li className="flex items-center gap-2 text-sm text-highlight_color font-semibold">
                ...
                <div className="pt-4 flex justify-center">
                    ...
                    <button className="w-full h-16 border-2 border-main text-main font-black rounded-full hover:text-white duration-300">
                        <span className=""></span>
                        Purchases
                    </button>
