...
const Banner = () => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 justify-evenly gap-6 items-center max-w-[2520px] mx-auto xl:px-20 md:px-10 sm:px-2 px-4">
      <div className="">
        <h1 className="text-2xl md:text-5xl font-semibold">Unlock Your Potential with
        ...
        <Link href="/signup">
        <button className="btn rounded-full btn-md lg:btn-lg shadow-highlight_color shadow-lg hover:shadow-sub_color hover:shadow-xl bg-sub_color text-neutral-50 hover:bg-highlight_color hover:text-main  font-semibold">Get Started - it&apos;s free</button>
        </Link>
      </div>
      <div>
        <BannerLottie />
