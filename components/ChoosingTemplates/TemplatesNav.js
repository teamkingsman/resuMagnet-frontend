...
const TemplatesNav = () => {
    ...
    const handleDownloadPDF = () => {
        // Assuming you have the URL of the PDF download endpoint
        const pdfDownloadUrl = `${process.env.BASE_URL}/download/pdf/${objectId}`;
                ...
                <div className="flex-1">
                    <button className="">
                        <Link href="/" className="flex flex-row gap-2 items-center">
                            <span className="text-sub_color"><IoCaretBack /></span>
                            <span className="text-sm md:text-lg text-sub_color">Back To Home</span>
                        </Link>
                    </button>
                </div>
                            ...
                            {pathname !== "/dashboard/cover_letter/preview" && (
                                <div className="drawer drawer-end">
                                    ...
                                    <div className="drawer-content">
                                        {/* Page content here */}
                                        <label htmlFor="my-drawer-4" className="drawer-button btn rounded-full btn-sm shadow-lg 
                                         hover:shadow-xl bg-sub_color text-neutral-50
                                         hover:bg-highlight_color hover:text-main  font-semibold ">
                                            Share
                                        </label>
                                    </div>
                                    <div className="drawer-side">
                                        ...
                                        <ul className="menu p-4 w-72 md:w-80 min-h-full bg-base-200 text-base-content">
                                            ...
                                            <li
                                                className="btn btn-sm md:btn-md lg:btn-lg w-3/4 mx-auto bg-sub_color py-4 mt-4"
                                                onClick={handleDownloadPDF}
                                            >
                                                <span className="text-highlight_color">Download PDF</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
