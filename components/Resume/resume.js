    ...
    return (
        <>
             <div className=" font-serif  lg:w-[800px] h-[1200px] mx-auto shadow-2xl bg-slate-300">
               ...
               {
                  resume.basicInfo.map((info,index)=>(
                    <>
              ...
              <h1 className="text-xl font-bold">{info.fname} {info.lname} </h1>
             </div>
            <div className="mr-4 mt-8"> 
                    <div key={index}>
                       <h2>Email:{info.email}</h2> 
                       <h2>Contact:{info.phone}</h2>
                       <h2>Address:{info.street}</h2>
                    </div>
                    </div>
    </div> 
                    </>
    ...
    <div className="ml-8 mr-4">
        {
          resume.basicInfo.map((info,index)=>(
            ...
            <p className=" justify-center text-md">{info.about}</p>
          </div>
            ))
        }
