  ...
  return (
    <>
      <div className=" mt-8  font-serif  lg:w-[800px] h-[700px] mx-auto shadow-2xl ">
        <div className="flex">
          {/* left */}
          <div className="w-1/4 text-sm bg-[#808080] lg:text-lg mx-auto  lg:h-[600px] bg-slate-300  shadow-slate-400">
            <div className=" ml-4">
              <div>
                <div className="mt-4">
                  {basicInfo?.photoURL && (
          ...
          <div className="w-3/4 h-[600px] bg-slate-50">
            <div className="p-4">
              <div>
                <h1 className="mt-10 text-2xl font-bold text-center underline">
                  CURRICULUM VITE
                </h1>

                <p className="text-md font-serif mt-4">
                  {" "}
                ...
                <div className=" mt-2">
                  <div className=" py-4">
                    {employment?.map((employment, index) => (
                      <div key={index}>
                        <h2 className="text-sm font-semibold flex gap-8">
